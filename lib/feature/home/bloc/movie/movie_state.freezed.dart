...
mixin _$MovieState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<MoviesEntity> data) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<MoviesEntity> data)? success,
...
abstract class _$$SuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<MoviesEntity> data});
}
...
class _$SuccessImpl with DiagnosticableTreeMixin implements Success {
  const _$SuccessImpl(final List<MoviesEntity> data) : _data = data;

  final List<MoviesEntity> _data;
  @override
  List<MoviesEntity> get data {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'MovieState.success'))
...
abstract class Success implements MovieState {
  const factory Success(final List<MoviesEntity> data) = _$SuccessImpl;
...
class _$ErrorImpl with DiagnosticableTreeMixin implements Error {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'MovieState.error'))
